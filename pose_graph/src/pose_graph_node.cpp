...
int main(int argc, char **argv)
{
    ...
    if (LOOP_CLOSURE)
    {
        ...
        fsSettings["/zed2/zed_node/right/image_rect_color"] >> IMAGE_TOPIC;        
    ...
    ros::Subscriber sub_image = n.subscribe("/zed2/zed_node/right/image_rect_color", 2000, image_callback);
